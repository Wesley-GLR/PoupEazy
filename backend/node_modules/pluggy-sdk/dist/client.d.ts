...
export declare class PluggyClient extends BaseApi {
     ...
     */
    fetchTransactionsCursor(accountId: string, options?: TransactionCursorFilters): Promise<CursorPageResponse<Transaction>>;
    /**
     ...
     */
    fetchAllTransactions(accountId: string, options?: Omit<TransactionCursorFilters, 'after'>): Promise<Transaction[]>;
    /**
