...
class PluggyClient extends baseApi_1.BaseApi {
     ...
     */
    fetchTransactionsCursor(accountId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.createGetRequest('v2/transactions', Object.assign(Object.assign({}, options), { accountId }));
        });
    }
    /**
     ...
     */
    fetchAllTransactions(accountId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const firstPage = yield this.fetchTransactionsCursor(accountId, options);
            ...
            while (next !== null) {
                ...
                const page = yield this.fetchTransactionsCursor(accountId, Object.assign(Object.assign({}, options), { after: afterParam }));
     ...
     */
    fetchConsents(itemId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.createGetRequest('consents', Object.assign(Object.assign({}, options), { itemId }));
        });
    }
    /**
     * Fetch consent by id
    ...
    fetchConsent(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.createGetRequest(`consents/${id}`);
        });
    }
    /**
